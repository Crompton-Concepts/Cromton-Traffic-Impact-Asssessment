...
def build() -> None:
    ...
    for feat in features:
        ...
        aadt = parse_number(first_prop(
            props, "ALLVEHS_AADT", "ALLVEHS_AA", "AADT", "ALL_VEHS_AADT", "TWO_WAY_AADT", "TWO_WAY_AA",
            "AADT_ALL_VEHICLES", "VOLUME", "ALLVEHS_MMW", default=None))
        ...
        road_name = str(first_prop(props, "DECLARED_ROAD", "ROAD_NAME", "LOCAL_ROAD_NM",
                                   "ROAD_ALIAS", default="VIC Road")).strip().title()
        flow = str(first_prop(props, "FLOW", "DIRECTION", "ROUTE_DIRECTION", "FLOW_DIR")).strip().upper()
        direction = "BOTH"
        ...
        feature = make_point_feature(
            ...
            lon=lon, lat=lat,
            traffic_count=aadt,
            year=safe_year(first_prop(props, "AADT_YEAR", "YEAR", "YR", "COUNT_YEAR", default=None)),
            lga=str(first_prop(props, "LGA_NAME", "LGA")).strip().title(),
